...
<table align="left"  width="100%">
		...
		<tr>
			<td colspan="2">
				<@CommonQueryMacro.DataTable id ="datatable"  paginationbar="btApprove,-,btReject" fieldStr="select,traceno[200],action,status[140],vdate,merid[120],payerbank,payeracct,payername,payeeacct,payeename,amt,curcd,nar1"  width="100%"   hasFrame="true"/>
			</td>
		</tr>
	</table>
