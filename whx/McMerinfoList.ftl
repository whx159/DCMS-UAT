...
function initCallGetter_post(){	
	McMerinfoList_interface_dataset.setFieldHidden("qsettlaccount",false);
}
//刷新数据
function flushPage(){
...
function btnUpload_onClick(){
	var currentSubWin = openSubWin("pageWinId", "${Common_Button_upload}", "/fpages/hsbc/jsp/download.jsp?fileflag=McMerinfoList","600","180");
}
