	...
	<tr>
		...
		<@CommonQueryMacro.GroupBox id="guoupbox1"  expand="true">
			<table align="center"  width="100%">
		         <tr>
			      	<td  align="left">
							<@CommonQueryMacro.Group id="group1" label="Static QR Code Generation" labelwidth="10%" fieldStr="mername,qtransedit,qamt,qdate,proxyvalue,qtransno,blank" colNm="4"/></br>
			        </td>
	   			 </tr>
				<tr>
					<td align="center">
