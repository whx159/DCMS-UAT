	...
	<table id="mytable">
		...
		<tr>
			<td class="listcenter_right">
				...
				<a extra="button" type="button" id="btSave" resultdataset="" plain="false" href="javascript:void(0)"  onclick="closeWindow()" iconcls="" onClick="return uploadFile1();" submitmanager="_submitmanager_default" autoform="dtResult" class="l-btn" noextra="true"><span class="l-btn-left"><span class="l-btn-text "><%=MessageResourceUtil.getMessage("Message.ReturnImputPage")%></span></span></a>
			</td>
		</tr>
	</table>
  </body>
