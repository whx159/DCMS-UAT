...
<table align="left"  width="100%">
		...
		<tr>
		 <#if v_country=="TH" >
			<td colspan="2">
				<@CommonQueryMacro.DataTable id ="datatable"   fieldStr="orderno,txndate[140],revtime,merid,mernm,pmtchan[140],txnamt[150],agtfee[170],hsbcfee[150],status[170]"  width="100%"   hasFrame="true"/>
			</td>
		  <#elseif v_country=="ID" >
			<td colspan="2">
