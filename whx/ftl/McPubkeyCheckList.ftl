...
<script type='text/javascript' src='${contextPath}/dwr/interface/CheckAction.js'> </script>
	<table align="left"  width="100%">
		...
		<tr>
			<td colspan="2">
				<@CommonQueryMacro.DataTable id ="datatable" paginationbar="btApprove,-,btReject" fieldStr="select,clientid[150],action,status[120],uptlr[200],uptime[200],expirytime[200],creid,cretimeShow[150],modid,modtimeShow[150],chkid,chktimeShow[150]" width="100%"   hasFrame="true"/>
			</td>
		</tr>
	</table>
