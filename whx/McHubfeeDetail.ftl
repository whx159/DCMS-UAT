...
<script type='text/javascript' src='${contextPath}/dwr/interface/CheckAction.js'> </script>
	...
	<table width="90%" cellpadding="2">
		...
		<tr>
			...
			<td width="25%" colspan="1" align="right" nowrap class="labeltd"><@message code="McHubfeeCheckList.Field.remarks2" /></td>
			<td width="25%" class="datatd"><@CommonQueryMacro.SingleField fId="remarks"/></td>
		</tr>
		<#if v_op=="detail">
		<tr>
