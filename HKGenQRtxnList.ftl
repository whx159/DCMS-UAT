...
<table align="left"  width="100%">
		<tr>
			<td colspan="2">
				<#if v_country=="HK">
					<@CommonQueryMacro.Interface id="interface" fieldStr="tstartdate,tenddate,sstartdate,senddate,tmerId,ttxnId,tamount,tstatus,samount,tcurrency,sfpstxid,qsettlaccount,trantype" label="${COMMON_QUERY_SELECT}" colNm="4"/>
				<#else>
