	...
	<tr>
		...
		<@CommonQueryMacro.CommonQuery id="McMerinfoTmpList" init="true" navigate="false"  submitMode="all">
            ...
            <table>
                ...
                <#if v_country=="ID">
	                 <tr>
	                	<td align="right" nowrap class="labeltd" width="15%">VA Url</td>
...
function initCallGetter_post(){
	...
	if(v_country =="MY"){
			McMerinfoTmpList_dataset.setFieldRequired("merchantkid",false);
			McMerinfoTmpList_dataset.setFieldRequired("hsbckid",false);
			McMerinfoDetailList_dataset.setFieldRequired("merchantkid",false);
			McMerinfoDetailList_dataset.setFieldRequired("hsbckid",false);
	}
...
function btApprove_onClickCheck() {
	var sharedkey = McMerinfoTmpList_dataset.getValue("sharedkey");
	var shared = sharedkey.replace(/\r\n/g,"");
	var shared = shared.replace(/\n/g,"");
	McMerinfoTmpList_dataset.setValue("sharedkey",shared);
