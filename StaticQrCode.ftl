	...
	<tr>
		...
		<@CommonQueryMacro.GroupBox id="guoupbox1"  expand="true">
			<table align="center"  width="100%">
		         <tr>
			      	<td  align="left">
							<@CommonQueryMacro.Group id="group1" label="Static QR Code Generation" labelwidth="10%" fieldStr="mername,qtransedit,qamt,qdate,proxyvalue,qtransno,imgorpdf,blank" colNm="4"/></br>
			        </td>
	   			 </tr>
				<tr>
					<td align="center">
...
<script language="javascript">
    ...
    function initCallGetter_post(){
    	...
    	staticQrCode_dataset.setValue("imgorpdf","PDF");
    }
...
        var imgUrl = img.getAttribute("src");
    ...
    function btSave_onClick(){
    	...
    	var imgorpdf = staticQrCode_dataset.getValue("imgorpdf");
    	var flag = 0;
    	/*
    	if(merid == ""){
    	...
    	*/
		...
		if(_transno == ""){
		 ...
		 if(imgorpdf == "PDF"){
			...
			window.location.href = "${contextPath}/dwr/DownFileAction.do?filename="+fileName+ '.' + 'png';
		 }
    }
