		...
		<table id="mytable" class="grouptable" width="100%" cellspacing="0">
			...
			<tr id="headinfo">
				...
				<td align="left" class="" colspan="3">
					<textarea  required="true" wrap="hard" name="headerInfo" maxlength="2048" style="width: 100%; resize:none;border: 1px solid #E5E5E5;overflow: auto; height: 51px" class="mytxt" ></textarea>
				</td>
			</tr>
			<tr id="pos">
