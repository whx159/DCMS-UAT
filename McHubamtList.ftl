...
<table align="left"  width="100%">
		...
		<tr>
			<td colspan="2">
				<@CommonQueryMacro.DataTable id ="datatable" paginationbar="btAdd"  fieldStr="opr[180],traceno,status[140],vdate,merid,payerbank,payeracct,payername,payeeacct,payeename,amt,curcd,creid,cretimeShow[150],modid,modtimeShow[150],chkid,chktimeShow[150],nar1[250]"  width="100%"   hasFrame="true"/>
			</td>
		</tr>
		<tr align="center">
            <td>
